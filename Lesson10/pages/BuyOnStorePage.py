...
class BuyOnStorePage():
    allure.step("Открыть сайт магазина: https://www.saucedemo.com/")
    ...
    allure.step("Заполнение поля Password и клик по кнопке Login")
    ...
    allure.step("Отображение итоговой стоимости (Total)")
